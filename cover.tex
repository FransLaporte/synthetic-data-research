...
\begin{tikzpicture}[remember picture,overlay,x=1mm,y=1mm]
  ...
  \begin{scope}[shift={(current page.north west)}]
    ...
    \node[anchor=north west,inner sep=0,text width=80mm] at (24,-223) {\eyebrow{Authors}\vspace{2mm}{\fontsize{12}{17}\selectfont Frans Laporte\\Florent Kegler}};
    \node[anchor=north west,inner sep=0,text width=70mm] at (114,-223) {\eyebrow{Course}\vspace{2mm}{\fontsize{11}{15}\selectfont Academic Research Skills}\par\vspace{2mm}{\small Literature review / Working draft}};
    \draw[rulegray,line width=.4pt] (24,-251)--(186,-251);
    \node[anchor=north west,inner sep=0,text width=83mm,text=muted] at (24,-262) {\fontsize{8}{11}\selectfont Faculty of Electrical Engineering,\\Mathematics and Computer Science\\September 2026};
    % Institutional text, not a recreation of the official logo.
    \node[anchor=north east,align=right,inner sep=0] at (186,-261) {\fontsize{16}{17}\selectfont\bfseries UNIVERSITY\\\fontsize{16}{17}\selectfont\bfseries OF TWENTE};
  \end{scope}
\end{tikzpicture}
\null
\end{titlepage}
