...
\begin{tikzpicture}[remember picture,overlay,x=1mm,y=1mm]
  ...
  \begin{scope}[shift={(current page.north west)}]
    ...
    \node[anchor=north west,inner sep=0,text width=72mm] at (114,-217) {\eyebrow{Topic contact}\vspace{2mm}{\fontsize{9}{12}\selectfont\TopicContactLink\\\TopicContactEmailLink}};
