...
\begin{tikzpicture}[remember picture,overlay,x=1mm,y=1mm]
  ...
  \begin{scope}[shift={(current page.north west)}]
    ...
    \node[anchor=north west,inner sep=0,text width=80mm] at (24,-223) {\eyebrow{Authors}\vspace{2mm}{\fontsize{12}{17}\selectfont Frans Laporte BSc.\\Florent Kegler BSc.}};
    ...
    \node[anchor=west,inner sep=0] at (24,-247) {\fontsize{8}{10}\selectfont Topic contact: \TopicContactLink};
    ...
    \node[anchor=north east,inner sep=0] at (186,-258) {\includegraphics[width=58mm]{Images/UTLogo.png}};
  \end{scope}
\end{tikzpicture}
\null
\end{titlepage}
